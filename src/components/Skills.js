    ...
    <div className="flex flex-col justify-between bg-white shadow-md rounded rounded-md">
      <div>
        ...
        <div className="flex justify-between mt-5 ml-5 mr-5">
          <img className="w-14" src={ambassador} alt="" />

          <img className="w-14" src={CSA} alt="" />

          <img className="w-14" src={dataAnalyst} alt="" />

          <img className="w-14" src={penTest} alt="" />

          <img className="w-14" src={RPA} alt="" />
